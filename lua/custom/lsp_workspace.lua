-- custom/lsp_workspace.lua (own module, loaded from config/autocmds.lua)
-- <leader>cL: send every unopened workspace file to the attached lsp,
-- so diagnostics cover the whole project, not just open buffers.
